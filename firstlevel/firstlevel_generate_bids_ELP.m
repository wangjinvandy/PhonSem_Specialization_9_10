...
%matched.
contrasts={'Sound' 'Meaning' 'Sound_vs_Meaning' 'Meaning_vs_Sound' 'Onset_vs_Rhyme' 'Low_vs_High'};
Sound=[-2 1 1 0];
Meaning=[-2 1 1 0];
...
rp_w=zeros(1,6);
empty=zeros(1,10);
weights={[Sound rp_w Sound rp_w empty empty]...
    [empty empty Meaning rp_w Meaning rp_w]...
    [Sound rp_w Sound rp_w -1*Meaning rp_w -1*Meaning rp_w]...
    [-1*Sound rp_w -1*Sound rp_w Meaning rp_w Meaning rp_w]...
    [Onset_vs_Rhyme rp_w Onset_vs_Rhyme rp_w empty empty] ...
    [empty empty Low_vs_High rp_w Low_vs_High rp_w]};
