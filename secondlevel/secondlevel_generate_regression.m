...
data=struct();
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/SemPhon_9_10/preprocessed';  %your project path
subjects={}; % your subjects
data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/SemPhon_9_10/data_info.xlsx'; %your subject list excel, if you have regressors, it's better there too.
if isempty(subjects)
    M=readtable(data_info);
    subjects=M.participant_id;
end

out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/SemPhon_9_10/secondlevel_t'; % your output folder of secondlevel analysis results
...
if cov==1
    name=[];
    %name{1}='PI_raw'; % This should be your column header in your excel, should be exactly to be the same as in your excel, otherwise it won't read in these covariates.
    name{1}='WC_raw';% This should be your column header in your excel
    val=[];
    for v=1:length(name)
        val{v}=M{:,name{v}};
    end
